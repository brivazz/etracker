...
from interfaces.telegram_bot.keyboards.build_category_keyboard import after_add_new_category_keyboard, add_category_keyboard
...
class CategoryOrchestrator(OrchestratorBase):
    ...
    async def show_keyboard_add_category(self, event: events.CallbackQuery.Event, user: UserInDBDTO):
    ...
    async def handle_add_category(self, event: events.NewMessage.Event, user: UserInDBDTO):
    ...
    async def handle_non_category(self, event: events.NewMessage.Event, user: UserInDBDTO):
