...
async def add_category_keyboard(
    event: events.CallbackQuery.Event, input_message_id: int | None = None
):
...
async def after_add_new_category_keyboard(
    event: events.NewMessage.Event, category_name, input_message_id
):
