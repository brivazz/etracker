...
handler.setFormatter(Formatter(fmt="[%(asctime)s: %(levelname)s] %(filename)s:%(funcName)s:%(lineno)d — %(message)s"))
...
class Settings(BaseSettings):
    ...
    tg_bot_token: str = Field(default='23423425234:aajdslfijsfij', description="Telegram BOT TOKEN")
