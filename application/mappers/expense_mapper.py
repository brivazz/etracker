from domain.entities.expense import ExpenseCreate, ExpenseInDB, ExpenseHistoryPeriod, ExpenseHistory, ExpenseEdit
from application.dto.expense_dto import ExpenseCreateDTO, ExpenseInDBDTO, ExpenseHistoryPeriodDTO, ExpenseHistoryDTO, ExpenseEditDTO
...
class ExpenseHistoryMapper(BaseMapper[ExpenseHistoryPeriodDTO, ExpenseHistoryPeriod, None]):
